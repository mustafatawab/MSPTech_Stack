...
export default function NewNavbar() {
  ...
  const navigation = [
    ...
    { title: "Grow With Us", path: "javascript:void(0)", isDrapdown: false },
    { title: "Support", path: "javascript:void(0)", isDrapdown: false },
  ...
  return (
    <>
      <nav
        className={`relative z-20 bg-transparent w-full md:static md:text-sm md:border-none ${
